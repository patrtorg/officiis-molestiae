# @patrtorg/officiis-molestiae

<a href="https://www.npmjs.com/package/@patrtorg/officiis-molestiae"><img alt="npm version" src="https://badge.fury.io/js/@patrtorg/officiis-molestiae.svg"></a>
<a href="https://npmjs.org/package/@patrtorg/officiis-molestiae"><img alt="Downloads" src="http://img.shields.io/npm/dm/@patrtorg/officiis-molestiae.svg"></a>
[![Build Status](https://travis-ci.org/mosch/@patrtorg/officiis-molestiae.svg?branch=master)](https://travis-ci.org/mosch/@patrtorg/officiis-molestiae)
[![Design](https://contribute.design/api/shield/mosch/@patrtorg/officiis-molestiae)](https://contribute.design/mosch/@patrtorg/officiis-molestiae)
...
Just use your favorite package manager to add `@patrtorg/officiis-molestiae` to your project:

```sh
yarn add @patrtorg/officiis-molestiae

npm i --save @patrtorg/officiis-molestiae

pnpm add @patrtorg/officiis-molestiae
```

## [Demo](https://@patrtorg/officiis-molestiae.netlify.com/)
...
import AvatarEditor from '@patrtorg/officiis-molestiae'
...
drag and drop support to anything really easy. Here is an example how to use it with @patrtorg/officiis-molestiae:
